...
\newacronym{SPF}{Sender Policy Framework}{description={
    SPF is explained fully in~\cite{openspf, wikipedia-spf}.
}}
...
\newacronym{DFA}{Deterministic Finite Automata}{description={
    XXX EXPLAIN DFA.  SHOULD IT BE NFA?
}}
...
% I think this is better than having both regex and regexs in the acronym
% list.
\newcommand{\regexs}{\regex{}s}
...
\newacronym{IP}{Internet Protocol address}{description={
