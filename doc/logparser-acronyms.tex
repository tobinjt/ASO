...
\newacronym{DNSBL}{DNS Blacklist}{description={
    ...
    currently connected client; if the requested hostname exists the client
    is on the DNSBL, and the mail server can decide what course of action
    to take.
}}
...
\newacronym{SLCT}{Simple Logfile Clustering Tool}{description={
    ...
    Risto Vaarandi for identifying and grouping similar log files, then
    producing a regex for each group of lines.
}}
