...
\newglossaryentry{DNSBL glossary}{
    ...
    description={
        ...
        \acronym[s]{DNSBL}, so before using one it is very important to
        check their listing policies.  To use a \acronym{DNSBL}, Postfix
        makes a DNS request incorporating the IP address of the client; if
        the requested hostname is found the client is on the
        \acronym{DNSBL}.
    }
}
...
\newcommand{\SMTPglossaryDescription}[0]{%
    ...
    protocol definition is in \acronym{RFC}~821~\cite{RFC821}, which was
...
\newglossaryentry{LMTP glossary}{
    ...
    description={
        ...
        is an \acronym{MTA}, and the server a delivery agent or a mail
...
\newglossaryentry{RFC glossary}{
    ...
    description={
        ...
        defining various protocols and file formats, e.g.\
        \acronym{SMTP}\@.  The name is somewhat misleading nowadays:
        initially the authors were asking for peer review, but these
        documents are now the de facto standards the Internet runs on.
    }
}
...
\newglossaryentry{pid glossary}{
    ...
    description={
        ...
        process has completed, the pid may be reused, because they are
...
\newglossaryentry{PDA glossary}{
    ...
    description={
        ...
        stack can be used in addition to the input.  In addition to the
        languages recognised by \acronyms{FA}, \acronyms{PDA} can recognise
        languages of the form $a^{n}b^{n}$, i.e.\ any number of one symbol
        followed by the same number of another symbol.
    }
}
