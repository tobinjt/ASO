...
\newacronym{MTA}{Mail Transfer Agent}{description={
    A Mail Transfer Agent sends and/or receives mail via SMTP\backslashat{}.
}}
...
\newacronym{regex}{Regular Expression}{description={
    Regular expressions are a concise and powerful method of matching patterns against
