...
\newglossaryentry{CFL glossary}{
    ...
    description={
        ...
        symbols.  Every CFG can be recognised by a \acronym{PDA}.
    }
}
...
\newglossaryentry{PDA glossary}{
    ...
    description={
        ...
        \acronym{FA}, but it can additionally use a stack to store data.
        A PDA can manipulate the stack during state transitions (adding or
        removing a single piece of data), and can use 
        the piece of data on the top of the stack in addition to the input
        when determining which state transition to take.  PDA can recognise
...
\newglossaryentry{DSN}{
    ...
    first={Delivery Status Notification (DSN)}
}
\newglossaryentry{DSN glossary}{
    name={Delivery Status Notification},
    description={
        XXX WRITE THE DESCRIPTION FOR DSN\@.
    }
}
