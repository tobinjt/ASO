...
\newacronym{SMTP}{Simple Mail Transfer Protocol}{description={
    ...
    recipient across the Internet.  %XXX A brief introduction to SMTP is
...
\newacronym{ATN}{Augmented Transition Networks}{description={
    ...
    Linguistics; they are originally described in~\cite{atns} and further
    in~\cite{nlpip}.
}}
...
\newacronym{NLP}{Natural Language Processing}{description={
    ...
    can understand human languages.  Potential applications include:
    programs which will automatically summarise a text; programs which
    can be taught facts, will understand questions and formulate answers to
    those questions.  It is in no way connected to Neuro-linguistic
    programming, which is generally found when searching for NLP.
}}
