...
action can be expressed in pseudo-code as shown in \figureref{Pseudo-code
describing how inputs are recognised}.
...
\sectionref{rules in implementation} for details) and increasing the chance
