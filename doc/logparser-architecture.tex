...
\begin{description}
    ...
    \item [Convert physical inputs to logical inputs] Each rule recognises
        ...
        although actions may use cascaded parsing (\sectionref{cascaded
        parsing}) to effectively push input back onto the input stream.  A
...
XXX MAYBE MOVE THIS EXAMPLE TO AN APPENDIX\@?  DO I EVEN NEED IT\@?  ASK
CARL ABOUT IT\@.
