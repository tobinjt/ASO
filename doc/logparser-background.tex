...
parse each log line (see \sectionref{rule characteristics in architecture}
for details).  Postfix's design is strongly influenced by security
concerns: those components that interact with other hosts are not
