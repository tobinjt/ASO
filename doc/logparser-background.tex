...
A detailed description of \SMTP{} is beyond the scope of this thesis:
...
restrictions and exceptions; policy servers (\sectionref{policy servers})
...
\begin{table}[ht]
    ...
    XXX HOW CAN I CENTRE THE TABLE\@?\hfill{}
