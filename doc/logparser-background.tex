...
top ten restrictions (sample output shown in \tableref{Truncated sample
output from SQL query showing percentages}):

XXX GENERATE THE FOLLOWING FROM THE SQL FILE FED TO SQLITE\@.
...
\begin{table}[ht]
    \caption{Truncated sample output from SQL query showing percentages}
    \empty{}\label{Truncated sample output from SQL query showing
    percentages}
    \begin{tabular}[]{lrr}
        \tableline{}
