...
\numberOFlogFILES{} test log files \LMA{} performs adequately, extracting
the small amount of information it aims to extract, with reasonable
results.  XXX CHECK THE RESULTS.
