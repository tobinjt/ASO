...
% XXX CHECK FOR ENTRIES THAT SHOULD BE INCLUDED.
...
\newglossaryentry{mail bomb}{name={Mail Bomb},description={
    ...
    their mailbox, too much disk space consumed.
}}
...
\newglossaryentry{mail loop}{name={Mail Loop},description={
    ...
    \texttt{alice@example.net}.  XXX EXPLAIN WHY THIS IS NOT AUTOMATICLLY
    DETECTED SOMETIMES\@.
}}
