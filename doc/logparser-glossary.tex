...
\newglossaryentry{Backscatter}{name={Backscatter},description={
    ...
    innocent servers are flooded with undeliverable mail notifications;
...
\newglossaryentry{<>}{name={$<>$},sort={<>},description={
    ...
    $<>$ for clarity.  All mail servers must accept mail sent from $<>$, or
    they are in violation of \acronym{RFC}~2821~\cite{RFC2821}.
}}
...
\newglossaryentry{hash}{name={hash},description={
    ...
    thesis, further information can be found at~\cite{hash-functions}.
}}
