...
\begin{eqlist}
    ...
    \item [dsn] The \acronym{DSN} code, similar to the \acronym{SMTP} code;
        it will only be present for log lines indicating delivery or
        rejection.  \acronym{DSN} support was added to Postfix in version
        2.3; logs generated by previous versions will not contain any DSN
        information.
