...
62--68, because their content is extremely skewed by two mail loops (see
\sectionref{Explaining the peaks in log file size}).  The action most
commonly specified by rules, \action{DELIVERY\_REJECTED}, is the third most
commonly invoked action; the most commonly invoked actions,
