...
\begin{boldeqlist}
    ...
    \item [restriction\_name] The name of the Postfix restriction that
        ...
        \texttt{DELIVERY\_REJECTED}; other rules should not set this field.
...
\begin{description}
    ...
    \item [DELETE] Deals with mail deleted using Postfix's administrative
        ...
        is attempted}), then invokes the COMMIT action to save the mail to
        the database.
    ...
    \item [EXPIRY] If Postfix has not managed to deliver a mail after
        ...
        having expired, so the COMMIT action will skip the valid
        combinations check.
    ...
    \item [PICKUP] The PICKUP action corresponds to the \daemon{pickup}
        ...
        created, although out of order log entries may have caused it to
        already exist, as documented in \sectionref{pickup logging after
        cleanup}.
...
\texttt{DELIVERY\_REJECTED}; hopefully the name of the restriction will be
