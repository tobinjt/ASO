...
\end{verbatim}
    ...
    \item \acronym{SQL} is reasonably standard and many people will already
        ...
        available for \gls{SQLite}, the default database used by the parser
        implementation.
...
\begin{enumerate}
    ...
    \item The hostname used in the HELO command is not logged if the mail
        ...
        2.4.7; this may possibly have changed in Postfix 2.5.  XXX TEST
        THIS AGAIN.}  Rectifying this is relatively simple: create a
