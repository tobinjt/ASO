...
\textsection\ref{Glossary}.} returns a different explanatory message; policy
...
differently, or running different versions of Postfix.  This paper
documents the difficult process of parsing Postfix log files, presenting
\PLP{}, a program which parses log files and places the resulting data into
a database for later use.  The gathered data can then be used to optimise
...
\sectionref{graphs} for illustrative purposes.  The section concludes with
