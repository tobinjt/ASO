...
of using a database schema as an \gls{API}, to provide a language-neutral
interface to the data gathered.  The novel separation of rules, actions,
...
Appendix~\ref{\glsautoprefix{main}} provides a glossary of terms used in
the thesis.

Appendix~\ref{\glsautoprefix{\acronymtype}} provides a list of acronyms
used in the thesis.

Appendix~\ref{\glsautoprefix{postfix}} gives a brief description of Postfix
daemons.
