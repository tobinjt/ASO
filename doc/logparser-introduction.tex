...
applied when mail is being transferred via \acronym{SMTP} is the goal of
...
provided in \sectionref{state of the art review}, beginning with a review
...
by a specific \acronym{DNSBL}).  This architecture is ideally suited to
