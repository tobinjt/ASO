...
off-peak times; detecting virus outbreaks that propagate via email; as a
...
of using a database schema as an \acronym{API}, to provide a
language-neutral interface to the data gathered.  The novel separation of
rules, actions, and framework is discussed, giving the reasons that
approach was taken when designing the parser.
