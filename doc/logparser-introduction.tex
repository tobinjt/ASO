...
their anti-spam measures has had in the last week, and possibly even
...
presenting \PLP{}, a program that parses log files and places the resulting
data into a database for later use.  The gathered data can then be used to
...
those measures are.  Numerous other uses are possible for such data:
