...
in \sectionref{complications}.  It does not differentiate between different
...
\newline{} (Last checked 2007/12/04.)
...
described later in this review, and the data extracted by \gls{PLP} is
...
extracted: from, to, RBL, client hostname, and client \gls{IP}\@.

\url{http://www.thesawmill.co.uk/formats/beta_postfix.html} \newline{}
Fields extracted: from, to, client hostname, client \gls{IP}, relay
hostname, relay \gls{IP}, status, response code, RBL, and message id.
