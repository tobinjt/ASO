...
efficiency}.  \Tableref{Summary of parsers' features} summarises the
results.
...
with the other difficulties documented in \sectionref{complications}.
...
\parserblurb{%
    ...
    and use and it's very powerful.
}
{http://www.splunk.com/}
{2008/11/23}
...
any of the other complications described in \sectionref{complications}.
