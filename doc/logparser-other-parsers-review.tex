...
\begin{tabular}{l|l|l|l|l}
    Parser              & Parsed     & Data        & Custom        & Compressed \\
                        & test logs? & store?      & reports?      & logs       \\
    \hline                                                                      \\
    Pflogsumm           & Yes        & No          & No            & No         \\
    Sawmill             & Yes        & Yes         & Searches      & Partially  \\
    Splunk              & Yes        & Yes         & Searches      & Yes        \\
                        &            &             & \& reports    &            \\
    Isoqlog             & No         & Yes         & No            & No         \\
    AWStats             & Partially  & Yes         & Partially\dag & Yes        \\
    Throughput monitor  & N/A        & No          & No            & No         \\
    Anteater            & No         & No          & No            & No         \\
    YAALA               & No         & Yes\ddag    & Yes           & No         \\
    Logparser/Lire      & Yes        & Yes         & Yes           & Yes        \\
    Logrep              & No         & Yes         & No            & No         \\
    Log Mail Analyser   & Yes        & Yes         & Partially     & No         \\ 
    \parsername{}       & Yes        & Yes\dag\dag & No            & Yes        \\
\end{tabular}

\dag AWStats can be configured to omit a section from a report, but not to
add extra sections.

\ddag YAALA only stores the data required to produce the latest report;
other data will be discarded.

\dag\dag\parsername{} is the only parser with documentation for its data store.
...
application.  Table \refwithpage{Summary of parsers' features} provides a
summary of the parsers' features.
