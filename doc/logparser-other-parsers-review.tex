...
summarises the results of this review.
...
\acronym{SMTP} code, \acronym{DSN} code, sender, recipient, size, message
ID, delay and delays.
...
timestamps for each log line, \acronym{DSN} code, delivery delays, or
...
than \parsername{}: it omits the HELO hostname, queueid, \acronym{DSN}
...
timestamps for each log line, \acronym{SMTP} and \acronym{DSN} codes,
...
(\urlLastChecked{http://www.debian.org/}{2008/11/23}) provides a manual
...
and \acronym{DSN} codes, size of each accepted mail, start and end times,
...
and end times, \acronym{DSN} code, delivery delays, timestamps of each log
line, and message ID\@. 
...
hostname, queueid, timestamps of each log line, \acronym{DSN} code, and
