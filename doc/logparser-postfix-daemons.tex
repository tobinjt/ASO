...
\newglossaryentry{bounce}{name={bounce},type={postfix},description={
    ...
    \urlLastChecked{http://www.postfix.org/bounce.8.html}{2009/02/23}.
}}
...
\newglossaryentry{cleanup}{name={cleanup},type={postfix},description={
    ...
    \urlLastChecked{http://www.postfix.org/cleanup.8.html}{2009/02/23}.
}}

\newglossaryentry{lmtp}{name={lmtp},type={postfix},description={
    Delivery of mail over \acronym{LMTP} is performed by the lmtp
    component.  The definitive documentation is
    \urlLastChecked{http://www.postfix.org/lmtp.8.html}{2009/02/23}.
}}
...
\newglossaryentry{local}{name={local},type={postfix},description={
    ...
    procmail (\urlLastChecked{http://www.procmail.org/}{2009/02/23}).  It
    also handles aliases and processing of a user's \texttt{.forward} file.
    The definitive documentation is
    \urlLastChecked{http://www.postfix.org/local.8.html}{2009/02/23}.
}}
...
\newglossaryentry{pickup}{name={pickup},type={postfix},description={
    ...
    definitive documentation is
    \urlLastChecked{http://www.postfix.org/pickup.8.html}{2009/02/23}.
}}
...
\newglossaryentry{postdrop}{name={postdrop},type={postfix},description={
    ...
    The definitive documentation is
    \urlLastChecked{http://www.postfix.org/postdrop.1.html}{2009/02/23}.
}}
...
\newglossaryentry{postsuper}{name={postsuper},type={postfix},description={
    ...
    \urlLastChecked{http://www.postfix.org/postsuper.1.html}{2009/02/23}.
}}
...
\newglossaryentry{qmgr}{name={qmgr},type={postfix},description={
    ...
    documentation is
    \urlLastChecked{http://www.postfix.org/qmgr.8.html}{2009/02/23}.
}}
...
\newglossaryentry{sendmail}{name={sendmail},type={postfix},description={
    ...
    (\urlLastChecked{http://www.sendmail.org/}{2009/02/23}) mail submission
    program that all Unix commands that send mail depend on; it executes
    \daemon{postdrop} to place a new mail in the queue.  The definitive
    documentation is
    \urlLastChecked{http://www.postfix.org/sendmail.1.html}{2009/02/23}.
}}

\newglossaryentry{smtp}{name={smtp},type={postfix},description={
    Delivery of mail over \acronym{SMTP} is performed by the smtp
    component.  The definitive documentation is
    \urlLastChecked{http://www.postfix.org/smtp.8.html}{2009/02/23}.
}}

\newglossaryentry{smtpd}{name={smtpd},type={postfix},description={
    Smtpd is the Postfix program that accepts mail via \acronym{SMTP}, and
    implements all the anti-spam restrictions Postfix provides.  The
    definitive documentation is
    \urlLastChecked{http://www.postfix.org/smtpd.8.html}{2009/02/23}.
}}
...
\newglossaryentry{virtual}{name={virtual},type={postfix},description={
    ...
    the @, whereas with \daemon{virtual} delivery the destination is
    determined by the entire email address.  E.g.\ if the server is
    responsible for both the \textbf{example.org} and \textbf{example.net}
    domains: \daemon{local} considers \textbf{john@example.org} and
    \textbf{john@example.net} to have the same mailbox, whereas
    \daemon{virtual} considers them to have different mailboxes.  Virtual
    delivery is used when a server hosts multiple domains where a username
    may be present in more than one domain but represent different users in
    each.  The definitive documentation is
    \urlLastChecked{http://www.postfix.org/virtual.8.html}{2009/02/23}.
}}
