...
\sectionref{scalability as the number of rules rises}.  \Tableref{Parsing
time relative to shuffled ordering table} shows that differences in rule
...
\Graphref{Parsing time relative to shuffled ordering including perfect best
and worst graph} shows the parsing times of the perfect best and perfect
worst oracles, and the optimal and reverse orderings relative to shuffled
ordering; \tableref{Parsing time relative to shuffled ordering, including
oracles table} shows mean and standard deviation.  As expected, the perfect
...
instead of perfect best oracle graph} and \graphref{Percentage decrease in
parsing time when using reverse ordering instead of perfect worst oracle
graph} show the percentage increase and decrease in parsing time when
...
\tableref{Percentage increase in parsing time when using optimal ordering
instead of perfect best oracle table} and \tableref{Percentage decrease in
parsing time when using reverse ordering instead of perfect worst oracle
table}.
...
time relative to shuffled ordering, including oracles}{Parsing time
relative to shuffled ordering including perfect best and worst graph}

\showtable{build/include-perfect-best-and-optimal-and-reverse-and-perfect-worst-vs-shuffle}{Parsing
time relative to shuffled ordering, including oracles}{Parsing time
relative to shuffled ordering, including oracles table}
...
\showgraph{build/graph-perfect-worst-vs-reverse}{Percentage decrease in
parsing time when using reverse ordering instead of perfect worst
oracle}{Percentage decrease in parsing time when using reverse ordering
instead of perfect worst oracle graph}

\showtable{build/include-perfect-worst-vs-reverse-stddev}{Percentage
decrease in parsing time when using reverse ordering instead of perfect
worst oracle}{Percentage decrease in parsing time when using reverse
ordering instead of perfect worst oracle table}
...
optimal, shuffled and reverse orderings is shown in \graphref{Percentage
