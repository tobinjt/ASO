...
\Graphref{Average number of rules tried per log line} shows the drop in the
average number of rules tried per log line for log files containing a mail
loop, and \graphref{Average number of rules tried per log line for each
Postfix component} shows the average number of rules tried per log line for
