...
and worst graph} shows the parsing times of the perfect best oracle and
...
\Graphref{Parsing time of perfect best oracle relative to optimal ordering}

\showgraph{build/graph-perfect-best-and-perfect-worst-and-optimal-and-reverse-vs-shuffled}{Parsing
times relative to shuffled ordering}{Parsing time relative to shuffled
ordering including perfect best and worst graph}

\showgraph{build/graph-perfect-best-vs-optimal}{Parsing time of perfect
best oracle relative to optimal ordering}{Parsing time of perfect best
oracle relative to optimal ordering}

\showgraph{build/graph-perfect-worst-vs-reverse}{Parsing time of perfect
worst oracle relative to reverse ordering}{Parsing time of perfect worst
oracle relative to reverse ordering}

\showtable{build/include-perfect-best-and-optimal-and-reverse-and-perfect-worst-vs-shuffle}{Parsing
time including perfect best and worst oracles relative to shuffled
ordering}{Parsing time including perfect best and worst oracles relative to
