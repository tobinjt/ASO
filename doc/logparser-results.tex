...
rule is zero, so optimal ordering performs similarly to shuffled ordering
for that log file.
...
component for each ruleset.  The optimal ordering shows a mean increase of
...
parsing time when not caching compiled regexes graph} at log files 22 \&
