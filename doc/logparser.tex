...
algorithm and program; and a list of other Postfix log parsers.
...
XXX ADD INFORMATION ABOUT OTHER POSTFIX LOG PARSERS HERE
...
XXX ADD RESOURCES ONCE THE PAPER IS REASONABLY COMPLETE AND THEN REFERENCE
THEM FROM WITHIN THE PAPER
