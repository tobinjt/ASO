...
\newcommand{\showgraph}[3]{%
    % XXX REVISIT THE PLACEMENT OF FIGURES AND TABLES, THOUGH I THINK
    % LATEX'S DEFAULTS ARE PROBABLY PRETTY GOOD.
    \begin{figure}%[hbt!]
        \caption{#2}\label{#3}
        \includegraphics{#1}
    \end{figure}
...
% XXX UPDATE THIS WHEN all-logs PASSES
...
\begin{abstract}
    ...
    XXX RUN ``test-some'' AGAIN TO UPDATE THE DB\@.
