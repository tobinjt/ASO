...
producing more warnings rather than fewer those 5 warnings represent only 3
...
the logs.  After parsing the 93 test log files the state tables contain 22
entries, breaking down into:

\begin{itemize}

    \item 2 connections which started only seconds before the logs ended
    ...
    \item 4 mails present for unknown reasons.
...
\begin{itemize}
    ...
    \item It appears that the hostname used in the HELO command is not
        ...
        and 2.3.11; this may possibly have changed in Postfix 2.4.}  It
