...
\begin{itemize}
    ...
    \item 7 mails (23 warnings) have out of order log entries, leading to
...
committal, ambiguity) for a problem which occurs only seven times in
60721709 log lines.
...
the logs.  After parsing the 93 test log files the state tables contain 27
...
\begin{itemize}
    ...
    \item 5 mails resulting from the out of order log entries described
        above.
