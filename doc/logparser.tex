...
XXX CONSIDER REPLACING bibtex, BECAUSE IT IS SUCH A PAIN IN THE ARSE TRYING
TO CHANGE THE FORMAT OF THE PRODUCED BIBLIOGRAPHY\@.
...
XXX CHECK URLS FOR BIBLIOGRAPHY ENTRIES, AND UPDATE LAST CHECKED DATES\@.

XXX SHOULD I SCRAP postfix\_action?

XXX ANNOTATE ALL URLS WITH LAST CHECKED DATE\@.

XXX STANDARDISE ON ``email'' OR ``mail'' EVERYWHERE\@?
