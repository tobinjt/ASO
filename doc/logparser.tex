...
% Sort numbers where there are multiple citations.  Doesn't appear to have
% any effect, though it does reduce the space between numbers.
\usepackage{cite}
...
XXX IS THERE A SYMBOL FOR APPENDIX, LIKE \textsection{} FOR SECTIONS\@?
