...
% Add space before urls to quell underfull hbox warnings.
\newcommand{\urlprefix}[0]{\hfill{}}
...
XXX IS IT POSSIBLE TO HAVE ACRONYMS THAT ARE NOT INCLUDED IN THE ACRONYM
LIST\@?
...
XXX IMPROVE BIBLIOGRAPHY APPEARANCE\@: NAMES LOOK UGLY (E.G.\ P.\ \empty{}.\
Porters), URL SPACING IS MESSED UP --- URLS \\SHOULD PROBABLY BE LAST, ON THEIR
OWN LINE\@.
...
% section.
XXX MOVE POSTFIX DAEMONS INTO A SEPARATE SECTION\@; NEED TO SWITCH TO NEW
GLOSSARY PACKAGE FIRST\@.
