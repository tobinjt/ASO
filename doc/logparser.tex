...
% With later TeX versions the dvips argument is necessary; everywhere else
% suggests using pdftex as the argument, but pdftex doesn't know how to
% include postscript images, so I need to create a dvi, convert it to
% postscript, and convert that to PDF.  I might lookup how to include
% postscript with pdftex.
