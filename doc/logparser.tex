...
implementation provides a program to ease the process of creating new rules
from unparsed lines, based on the algorithm developed by Risto
Vaarandi~\cite{risto-vaarandi} for \SLCT{}~\cite{slct-paper}.  The
differences between the two algorithms will be outlines as part of the
general explanation below.

The core of the algorithm was developed by Risto Vaarandi, and is quite
...
determines whether the word is fixed or variable.  This classification can
be used to group similar log lines and generate a \regex{} to match each
group of lines.
...
\begin{description}
    ...
    \item [Pre-process the file]
        ...
        In the original algorithm the preprocessing stage was 

    \item [Calculate the word frequency]
