...
% XXX WHY DOES USING \defaultplacement IN \showgraph AND \showtable CAUSE
% PLACEMENT PROBLEMS\@?
\newcommand{\defaultplacement}[0]{thbp}
% \showgraph{filename}{caption}{label}
\newcommand{\showgraph}[4][tbph]{%
    \begin{figure}[#1]%[hbt!]
        \caption{#3}\label{#4}
        \includegraphics{#2}
    \end{figure}
