...
\newcommand{\showgraph}[3]{%
    % XXX REVISIT THE PLACEMENT OF FIGURES, THOUGH I THINK LATEX'S DEFAULTS
    % AR EPROBABLY PRETTY GOOD.
    \begin{figure}%[hbt!]
        \caption{#2}\label{#3}
        \includegraphics{#1}
    \end{figure}
...
\begin{abstract}
    ...
    XXX WE NOW USE \daemon{virtual}, SO START PARSING THOSE LOG LINES\@.
