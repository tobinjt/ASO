...
NEED A BETTER TERM THAN HARD-CODED, THOUGH THAT MIGHT ARISE FROM THE
PREVIOUS TODO ITEM\@.
...
\begin{description}
    ...
    \item [Logparser/Lire] \textit{As any good system administrator knows,
        ...
        It supports multiple output formats (text, \HTML{}, PDF XXX and
...
\glossary{name={bounce},description={
    The definitive documentation is \url{http://www.postfix.org/bounce.8.html}.
}}
...
\glossary{name={local},description={
    The definitive documentation is \url{http://www.postfix.org/local.8.html}.
}}
...
\glossary{name={postdrop},description={
    The definitive documentation is \url{http://www.postfix.org/postdrop.1.html}.
}}

\glossary{name={postsuper},description={
    The definitive documentation is available at \url{http://www.postfix.org/postsuper.1.html}.
}}
...
\glossary{name={smtp},description={
    The definitive documentation is \url{http://www.postfix.org/smtp.8.html}.
}}
