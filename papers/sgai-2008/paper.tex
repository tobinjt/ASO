...
provides services to the actions, but doesn't need to perform any tasks
...
the user that they need to alter or extend their ruleset; the
...
\begin{description}
    ...
    \item [priority] Priority overrides hits when sorting rules, allowing
        ...
        mail must be discarded because it won't have all the data required
...
% Don't reformat this!
% XXX CONSIDER USING A TABLE ENVIRONMENT; IT DIDN'T LOOK GREAT BEFORE.
\begin{tabular}[]{ll}
    \hline
    \noalign{\smallskip}
    Attribute                 & Value                                            \\
