...
Trinity College \\ Dublin 2 \\ Ireland \\ \email{tobinjt@cs.tcd.ie}
...
Background of the project --- emphasise the variety in the log lines, and
the desire to achieve complete coverage, of both kinds.
Motivation for creating the parser.  At some point I MIGHT compare this
