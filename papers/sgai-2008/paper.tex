...
\graphref{Percentage execution time increase of maximum ruleset over
minimum ruleset}.  \showgraph{build/plot-normal-vs-smaller}{Percentage
...
It is clear from \graphref{Percentage execution time increase of maximum
...
\input{build/normal-vs-smaller-percentage-increase.tex} in execution time
...
rules increases, and that sorting the rules is an important optimisation
enabling this.
