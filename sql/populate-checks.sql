...
-- result_cols: result, warning, smtp_code, recipient, data (log_line will be added automatically)
-- connection_cols: ip, hostname, helo, sender
...
-- <cameraserver>: Sender address rejected: User unknown in local recipient table; from=<cameraserver> to=<shane.greenan@cs.tcd.ie> proto=SMTP helo=<best>
INSERT INTO checks(name, description, regex, result_cols, connection_cols)
    VALUES('Unknown sender, no domain', 'The sender address (no domain) is unknown on our system',
        '^<([^>]+?)>: Sender address rejected: User unknown in local recipient table; from=<(\1)> to=<(__RECIPIENT__)> proto=E?SMTP helo=<(__HELO__)>$',
        'recipient=2',
        'helo=3, sender=1'
);
...
INSERT INTO checks(name, description, regex, result_cols, connection_cols)
    VALUES('Unknown recipient domain', 'We do not accept mail from unknown domains',
...
INSERT INTO checks(name, description, regex, result_cols, connection_cols)
    VALUES('Invalid HELO', 'The client used an invalid hostname in the HELO command',
...
INSERT INTO checks(name, description, regex, result_cols, connection_cols)
    VALUES('Unknown recipient 2', 'The recipient address is unknown on our system (system users should not receive mail)',
...
INSERT INTO checks(name, description, regex, result_cols, connection_cols)
    VALUES('Unknown sender 3', 'The sender address is unknown on our system (system users should not send mail)',
...
INSERT INTO checks(name, description, regex, result_cols, connection_cols)
    VALUES('Unknown recipient 3', 'The recipient address is unknown on our system (user not receiving mail here any more)',
...
INSERT INTO checks(name, description, regex, result_cols, connection_cols)
    VALUES('Invalid HELO hostname', 'The hostname used in the HELO command is invalid',
